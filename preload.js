...
document.getElementById("sketchtosir").innerHTML= "Sketch To Be Drawn : " + sketch;         
var timer_counter= 0;      
var timer_check= "";
var drawn_sketch= "";
var answer_holder= "";
...
function checksketch() {
    ...
    document.getElementById("timeree").innerHTML= timer_counter;
...
function modelloaded() {
    console.log("model is loaded what r u doing!, try it!");
...
function gotResult(error,results) {
    if (error) {
        ...
        document.getElementById("sketchofname").innerHTML =drawn_sketch;
        document.getElementById("confidenceofconfidence").innerHTML = results[0].confidence.toFixed(3) ;
    }
